      ...
      useEffect(() => {
          ...
          .then(res => {
            if (res.data.length >0){
              ...
              console.log('AllCountryInfo',res.data[0]);
        ...
        <div className="row">
                        ...
                        <div className="card-body cleartfix p-1">
                          <div className="media d-flex ">
                            ...
                            <div className="align-self-center ms-auto p-1 ">
                              <h1>{analyzeData.AllCountryInfo.population}</h1>
                            </div>
                          </div>
                          {summaryInfo&&
                      ...
                      <div className="card-content">
                        <div className="card-body cleartfix p-1">
                          <div className="media d-flex ">
                            ...
                            <div className="media-body align-self-center mx-1">
                              <h4>Population</h4>
                              <span>Country Total Population</span>
                            </div>
                            <div className="align-self-center ms-auto p-1 ">
                              <h1>{analyzeData.AllCountryInfo.population}</h1>
                            </div>
          ...
          <div className="row justify-content-start">
            <div className="col-lg-6 col-12 m-1 "> 
              ...
              <Select
                className=""
                value={selectedChartModel}//{ label: "All", value: "All" }
                onChange={setSelectedChartModel}
                options={[{value:'PieChart',label:'PieChart'},{value:'BarChart',label:'BarChart'},{value:'LineChart',label:'LineChart'}]}
              />
            </div>
            <hr/>
          </div>
